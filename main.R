...
Rcpp::sourceCpp("mcmc_algo.cpp")
source("functions.R")


main <- function(Y,B=NULL,W,net=NULL,nsim=2000,ntune=1000,freqTune=100,nest=1000,nthin=10,
                 pars_ini=NULL,pattern,q,loc,vrbs=T){
  ...
  prob_select<-fdr_cut(PIPs,alpha=0.05)
